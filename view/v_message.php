...
//    ], 'warning', true);
    $content = Output::ShowAdvert('Cliquez sur le message pour le modifier directement. Cliquez ensuite sur le bouton modifier pour valider vos modifications.', 'info', true);
    $user = new User();
